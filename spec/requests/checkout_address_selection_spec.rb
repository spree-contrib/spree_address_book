...
describe "Address selection during checkout" do
  ...
  describe "as authenticated user with saved addresses", js: true do
    ...
    before do
      user.addresses << FactoryGirl.create(:address, :address1 => FFaker::Address.street_address, :state => state, :alternative_phone => nil)
      sign_in!(user)
    ...
    describe "using saved address for bill and new ship address", :js => true do
      let(:shipping) do
        FactoryGirl.build(:address, :address1 => FFaker::Address.street_address,
          :state => state)
      end
    ...
    describe "using saved address for ship and new bill address", :js => true do
      let(:billing) do
        FactoryGirl.build(:address, :address1 => FFaker::Address.street_address, :state => state, :zipcode => '90210')
      end
